# Create the NASA POWER API data collection module
nasa_power_api_code = '''"""
...
# Save the NASA POWER API module
with open('nasa_power_api.py', 'w') as f:
    f.write(nasa_power_api_code)

print("Created nasa_power_api.py")
print("File size:", len(nasa_power_api_code), "characters")